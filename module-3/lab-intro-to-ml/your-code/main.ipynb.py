 ...
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "' It treats this column as an object because the value \"-\"  can not be interpreted as a number, so all values\\nbecomes strings '"
      ]
     },
     "execution_count": 7,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "# Your code here\n",
    "def to_numeric(x):\n",
    "    return pd.to_numeric(x,downcast=\"float\",errors=\"coerce\")\n",
    "\n",
    "austin[wrong_type_columns] = austin[wrong_type_columns].apply(to_numeric)"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "TempAvgF                      1319 non-null int64\n",
      "TempLowF                      1319 non-null int64\n",
      "DewPointHighF                 1312 non-null float32\n",
      "DewPointAvgF                  1312 non-null float32\n",
      "DewPointLowF                  1312 non-null float32\n",
      "HumidityHighPercent           1317 non-null float32\n",
      "HumidityAvgPercent            1317 non-null float32\n",
      "HumidityLowPercent            1317 non-null float32\n",
      "SeaLevelPressureHighInches    1316 non-null float32\n",
      "SeaLevelPressureAvgInches     1316 non-null float32\n",
      "SeaLevelPressureLowInches     1316 non-null float32\n",
      "VisibilityHighMiles           1307 non-null float32\n",
      "VisibilityAvgMiles            1307 non-null float32\n",
      "VisibilityLowMiles            1307 non-null float32\n",
      "WindHighMPH                   1317 non-null float32\n",
      "WindAvgMPH                    1317 non-null float32\n",
      "WindGustMPH                   1315 non-null float32\n",
      "PrecipitationSumInches        1195 non-null float32\n",
      "Events                        1319 non-null object\n",
      "dtypes: float32(16), int64(3), object(2)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "#### In the next cell, identify all rows containing at least one missing value. Assign the dataframes with missing values to a variable \n",
    "called `missing_values`."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# Your code here\n",
    "124 / len(austin[\"PrecipitationSumInches\"])"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "23    2014-01-13         71        57        43           60.0          36.0   \n",
       "24    2014-01-14         76        57        37           31.0          25.0   \n",
       "25    2014-01-15         64        52        40           29.0          23.0   \n",
       "26    2014-01-16         72        56        40           31.0          27.0   \n",
       "27    2014-01-17         64        54        43           31.0          20.0   \n",
       "28    2014-01-18         70        54        37           41.0          33.0   \n",
       "29    2014-01-19         72        59        45           41.0          30.0   \n",
       "...          ...        ...       ...       ...            ...           ...   \n",
       "1289  2017-07-02        100        89        78           75.0          72.0   \n",
       "1290  2017-07-03         99        88        76           74.0          71.0   \n",
       "1291  2017-07-04        101        90        78           74.0          72.0   \n",
       "1292  2017-07-05         99        89        78           74.0          70.0   \n",
       "1293  2017-07-06        100        89        77           74.0          71.0   \n",
       "1294  2017-07-07         99        87        75           74.0          71.0   \n",
       "1295  2017-07-08        100        88        75           71.0          67.0   \n",
       "1296  2017-07-09        101        89        77           71.0          67.0   \n",
       "1297  2017-07-10        100        88        76           72.0          65.0   \n",
       "1298  2017-07-11        101        89        77           73.0          69.0   \n",
       "1299  2017-07-12        101        89        77           73.0          70.0   \n",
       "1300  2017-07-13        102        90        77           74.0          70.0   \n",
       "1301  2017-07-14        101        89        77           74.0          69.0   \n",
       "1302  2017-07-15        103        87        71           73.0          70.0   \n",
       "1303  2017-07-16         99        84        68           71.0          69.0   \n",
       "1304  2017-07-17         98        88        77           75.0          71.0   \n",
       "1305  2017-07-18        100        88        76           74.0          70.0   \n",
       "1306  2017-07-19        101        89        77           74.0          70.0   \n",
       "1307  2017-07-20        103        90        77           75.0          69.0   \n",
       "1308  2017-07-21        104        91        77           74.0          68.0   \n",
       "1309  2017-07-22        103        90        77           74.0          68.0   \n",
       "1310  2017-07-23        103        90        77           74.0          71.0   \n",
       "1311  2017-07-24        102        89        76           75.0          71.0   \n",
       "1312  2017-07-25        103        91        78           75.0          71.0   \n",
       ...
       "\n",
       "      SeaLevelPressureAvgInches  SeaLevelPressureLowInches  \\\n",
       "0                     29.680000                  29.590000   \n",
       "1                     30.129999                  29.870001   \n",
       "2                     30.490000                  30.410000   \n",
       "3                     30.450001                  30.299999   \n",
       "4                     30.330000                  30.270000   \n",
       "5                     30.400000                  30.340000   \n",
       "6                     30.389999                  30.340000   \n",
       "7                     30.170000                  30.040001   \n",
       "8                     30.100000                  29.990000   \n",
       "9                     30.330000                  30.260000   \n",
       "10                    30.389999                  30.270000   \n",
       "11                    30.110001                  30.010000   \n",
       "12                    30.370001                  30.150000   \n",
       "13                    30.350000                  30.139999   \n",
       "14                    29.950001                  29.809999   \n",
       "15                    30.080000                  29.790001   \n",
       "16                    30.680000                  30.500000   \n",
       "17                    30.520000                  30.360001   \n",
       "18                    30.200001                  30.120001   \n",
       "19                    30.110001                  30.000000   \n",
       "20                    29.870001                  29.750000   \n",
       "21                    30.059999                  29.870001   \n",
       "22                    30.010000                  29.900000   \n",
       "23                    30.010000                  29.860001   \n",
       "24                    30.129999                  30.010000   \n",
       "25                    30.330000                  30.170000   \n",
       "26                    30.129999                  30.059999   \n",
       "27                    30.290001                  30.209999   \n",
       "28                    30.190001                  30.100000   \n",
       "29                    30.219999                  30.120001   \n",
       "...                         ...                        ...   \n",
       "1289                  30.059999                  29.950001   \n",
       "1290                  30.000000                  29.889999   \n",
       "1291                  29.969999                  29.860001   \n",
       "1292                  30.010000                  29.920000   \n",
       "1293                  30.059999                  29.980000   \n",
       "1294                  30.049999                  29.980000   \n",
       "1295                  30.020000                  29.940001   \n",
       "1296                  29.990000                  29.910000   \n",
       "1297                  29.950001                  29.889999   \n",
       "1298                  29.959999                  29.870001   \n",
       "1299                  29.990000                  29.930000   \n",
       "1300                  30.059999                  29.969999   \n",
       "1301                  30.070000                  29.980000   \n",
       "1302                  30.010000                  29.940001   \n",
       "1303                  29.930000                  29.840000   \n",
       "1304                  29.900000                  29.840000   \n",
       "1305                  29.980000                  29.930000   \n",
       "1306                  30.070000                  29.990000   \n",
       "1307                  30.030001                  29.930000   \n",
       "1308                  29.950001                  29.860001   \n",
       "1309                  29.900000                  29.809999   \n",
       "1310                  29.879999                  29.820000   \n",
       "1311                  29.950001                  29.889999   \n",
       "1312                  30.030001                  29.950001   \n",
       "1313                  30.030001                  29.930000   \n",
       "1314                  29.969999                  29.879999   \n",
       "1315                  29.900000                  29.809999   \n",
       "1316                  29.860001                  29.790001   \n",
       "1317                  29.910000                  29.870001   \n",
       "1318                  29.969999                  29.910000   \n",
       "\n",
       ...
       "16           17.0         7.0         27.0                       \n",
       "17           13.0         5.0         22.0                       \n",
       "18           12.0         1.0         18.0                 Rain  \n",
       "19           12.0         3.0         19.0                  Fog  \n",
       "20           13.0         6.0         21.0                 Rain  \n",
       "21           12.0         3.0         19.0                       \n",
       "22           15.0         4.0         24.0                 Rain  \n",
       "23           17.0         7.0         29.0                       \n",
       "24           16.0         5.0         29.0                       \n",
       "25           14.0         4.0         21.0                       \n",
       "26           14.0         4.0         20.0                       \n",
       ...
       "1291         13.0         7.0         28.0                       \n",
       "1292         13.0         6.0         19.0                       \n",
       "1293         12.0         4.0         20.0         Thunderstorm  \n",
       "1294         15.0         3.0         27.0  Rain , Thunderstorm  \n",
       "1295          9.0         3.0         17.0         Thunderstorm  \n",
       "1296         12.0         4.0         19.0                       \n",
       "1297         12.0         5.0         20.0                       \n",
       "1298         14.0         7.0         22.0                       \n",
       "1299         13.0         6.0         20.0                       \n",
       "1300         10.0         3.0         19.0                       \n",
       "1301         15.0         4.0         22.0                       \n",
       "1302         23.0         3.0         35.0  Rain , Thunderstorm  \n",
       "1303         12.0         3.0         24.0                       \n",
       "1304         16.0         3.0         23.0  Rain , Thunderstorm  \n",
       "1305         14.0         5.0         20.0                       \n",
       "1306         18.0         5.0         29.0                       \n",
       "1307         14.0         5.0         22.0                       \n",
       "1308         14.0         5.0         24.0                       \n",
       "1309         13.0         6.0         22.0                       \n",
       "1310         13.0         4.0         24.0  Rain , Thunderstorm  \n",
       "1311         13.0         3.0         19.0  Rain , Thunderstorm  \n",
       "1312         15.0         7.0         24.0                       \n",
       "1313         15.0         6.0         27.0                       \n",
       "1314         12.0         5.0         21.0                       \n",
       "1315         14.0         5.0         20.0                       \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "      ...       VisibilityAvgMiles  VisibilityLowMiles  WindHighMPH  \\\n",
       "0     ...                      7.0                 2.0         20.0   \n",
       "1     ...                     10.0                 5.0         16.0   \n",
       "2     ...                     10.0                10.0          8.0   \n",
       "3     ...                     10.0                 7.0         12.0   \n",
       "4     ...                     10.0                 7.0         10.0   \n",
       "\n",
       "   WindAvgMPH  WindGustMPH               Events  Snow  Fog  Rain Thunderstorm  \n",
       "0         4.0         31.0  Rain , Thunderstorm     0    0     0            0  \n",
       "1         6.0         25.0                          0    0     0            0  \n",
       "2         3.0         12.0                          0    0     0            0  \n",
       "3         4.0         20.0                          0    0     0            0  \n",
       "4         2.0         16.0                          0    0     0            0  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "   WindAvgMPH  WindGustMPH               Events  Snow  Fog  Rain Thunderstorm  \n",
       "0         4.0         31.0  Rain , Thunderstorm     0    0     1            1  \n",
       "1         6.0         25.0                          0    0     0            0  \n",
       "2         3.0         12.0                          0    0     0            0  \n",
       "3         4.0         20.0                          0    0     0            0  \n",
       "4         2.0         16.0                          0    0     0            0  \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "def to_date(x):\n",
    "    d = dt.strptime(x,'%Y-%m-%d')\n",
    "    return d.toordinal()\n",
    "\n",
    "austin_fixed[\"Date\"]= austin_fixed[\"Date\"].apply(to_date)\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "#### Now, call `svm.SVC.fit()` on `X_train` and `y_train`. Assign the returned value to a variable called `clf` which stands for \n",
    "\n",
    "*classifier*. Then obtain the test score for `X_test` and `y_test` by calling `clf.score()`."
   ]
  },
  {
   "cell_type": "code",
